...
public extension String {
    ...
    static func collectKindString(of type: CollectionKindType) -> String {
        return type == .header ? UICollectionView.elementKindSectionHeader : UICollectionView.elementKindSectionFooter
    }
    
    func isKind(of type: CollectionKindType) -> Bool {
...
public extension UIKitSetting where Base : UICollectionView {
    ...
    func register<T>(_ cellClass: T.Type) -> Self where T : UICollectionViewCell {
        self.base.register(cellClass, forCellWithReuseIdentifier: cellClass.identifier)
        return self
    }
    /// 注册Header/Footer
    @discardableResult
    func register<T>(_ supplementaryClass: T.Type, for registerType: UICollectionViewReusableSupplementary) -> Self where T : UICollectionReusableView {
        self.base.register(supplementaryClass, forSupplementaryViewOfKind: registerType.kind, withReuseIdentifier: supplementaryClass.identifier)
        return self
    }
...
public extension UICollectionView {
    ...
    func reusable<T>(_ cellClass: T.Type, at indexPath: IndexPath) -> T where T : UICollectionViewCell {
        return self.dequeueReusableCell(withReuseIdentifier: cellClass.identifier, for: indexPath) as! T
    }
    ...
    func reusable<T>(_ supplementaryClass: T.Type, at indexPath: IndexPath, kind supplementaryKind: String) -> T where T : UICollectionReusableView {
        return self.dequeueReusableSupplementaryView(ofKind: supplementaryKind, withReuseIdentifier: supplementaryClass.identifier, for: indexPath) as! T
    }
}
