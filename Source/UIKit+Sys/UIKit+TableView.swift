...
public extension UIKitSetting where Base : UITableView {
    ...
    func register<T>(_ cellClass: T.Type) -> Self where T : UITableViewCell {
        self.base.register(cellClass, forCellReuseIdentifier: cellClass.identifier)
        return self
    }
    ...
    func register<T>(_ supplementaryClass: T.Type) -> Self where T : UITableViewHeaderFooterView {
        self.base.register(supplementaryClass, forHeaderFooterViewReuseIdentifier: supplementaryClass.identifier)
        return self
    }
}
...
public extension UITableView {
    ...
    func reusable<T>(_ supplementaryClass: T.Type) -> T? where T : UITableViewHeaderFooterView {
        return self.dequeueReusableHeaderFooterView(withIdentifier: supplementaryClass.identifier) as? T
    }
}
